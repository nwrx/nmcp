...
static DEFAULT_KUBECONFIG_PATH: &str =
    "/home/shorwood/Workspaces/unmcp/k3s/kubeconfig/kubeconfig.yaml";
...
impl TestContext {
    pub async fn get_client(&self) -> Result<Client> {
        ...
        let client_config =
            Config::from_custom_kubeconfig(kubeconfig, &client_config_options).await?;
...
mod tests {
    ...
    async fn test_get_client_default() {
        ...
        assert_eq!(
            api_version.git_commit,
            "35a47239188444222067c25cc096346adb20401f"
        );
    }
}
